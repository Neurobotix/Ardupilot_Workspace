...
| `assets/missions/gps_failure_behavior_mission.waypoints` | waypoint mission | GPS failure behavior mission v4: 100 m cruise, 500 m calm-lane settle, 2000 m outbound/reciprocal legs with 500 m spacing, seq-4 injection, seq-9 RTL. | active candidate | GPS failure docs/runbooks and `GpsFailureConfig`. | v4 no-live geometry test passed; source hash `8d1c8de43c6e...`; v3 hash `3d111b32351a...` was raw-nominal validated 2026-07-14 at `var/runs/gps_failure_behavior_20260714T122459635208Z/`; v2 hash `c372bf6253c9...` is historical and exposed the pre-injection turnback |
...
- worlds: 15 `.sdf` files under `assets/worlds/`;
- missions: 12 non-archive `.waypoints` files under `assets/missions`, plus
