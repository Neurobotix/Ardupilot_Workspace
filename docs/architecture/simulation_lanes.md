...
| GPS failure behavior | Behavior characterization under degraded/corrupted GPS signal (drift/glitch/denial/jamming); EKF innovation-gate "knee"; `test_suite` plugin lane | `plane-cte` + `gazebo-plane-cte` (plugin-owned launch) | No | Phase 0 design lock accepted 2026-07-06; plugin and live runs open. See `docs/architecture/gps_failure_lane.md` |
