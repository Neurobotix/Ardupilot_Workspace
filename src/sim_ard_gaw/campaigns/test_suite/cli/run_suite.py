...
def run_from_args(args: argparse.Namespace, *, title: str = "test_suite.cli.run_suite") -> None:
    """Execute a sequential suite from parsed args.
...
def main() -> None:
    args = _parse_args()
    resolve_runner_plugin_or_exit(args.plugin, "run_suite")
    run_from_args(args)
